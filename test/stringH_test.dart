...
void main() {
  ...
  group("getInBracketsRight", () {
    ...
    test("getInBracketsRight1",
        () => exp_getInBracketsRight("out b4((inner) outer)out aft", "((inner) outer)"));
    test("getInBracketsRight2", () => exp_getInBracketsRight(fnDef5, "()"));
    test("getInBracketsRight3",
        () => exp_getInBracketsRight("bl(blim) (plumpy(stumpy))", "(plumpy(stumpy))"));
  });
  ...
  group("bracketPositionRight", () {
    ...
    test(
        ...
        () => exp_bracketPositionRight(
            "bl(blim) (plumpy(stumpy))", Optional.fromNullable(StrPos(10, 24))));
    test(
        "bracketPositionRight2",
        () => exp_bracketPositionRight(
            "sd()fsdf(l1a(l2a)l1b(l2a)l1c", Optional.fromNullable(StrPos(21, 24))));
    test(
        "bracketPositionRight3",
        () => exp_bracketPositionRight(
            "sd()fsdf(l1a(l2a)l1b(l2a)l1c)", Optional.fromNullable(StrPos(9, 28))));
    test("bracketPositionRight4", () => exp_bracketPositionRight("", Optional.absent()));

    test("bracketPositionRight5", () {
      var input = "sd()fsdf(l1a(l2a)l1b(l2a)l1c";
      var expected = "l2a";
      var stringInBrackets = bracketPositionRight(input);
      var result = input.substring(stringInBrackets.value.start, stringInBrackets.value.end);
